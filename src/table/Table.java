	...
	public static void main(String[] args) throws InterruptedException {
			...
			for(int i=1;i<=TotalRows;i++) {
				for(int j=1;j<=TotalColoumn;j++) {
					if(i==1) {
						String Headers = driver.findElement(By.xpath("(//table[@id='product']//tr)["+i+"]//th["+j+"]")).getText();
						System.out.print(Headers+"||");
					
					}
					else {
						String Rowdata = driver.findElement(By.xpath("(//table[@id='product']//tr)["+i+"]//td["+j+"]")).getText();
